...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'nevada': // new bg for phase 0
				var sky:BGSprite = new BGSprite('phase0/nevadasky', -1350, -850, 0.9, 0.9);
				sky.updateHitbox();
				add(sky);

				var ground:BGSprite = new BGSprite('phase0/nevadaground', -2100, -1010, 0.9, 0.9);
				ground.setGraphicSize(Std.int(ground.width * 1.4));
				ground.updateHitbox();
				add(ground);

			case 'nevadaold': // old bg for phase 0
				var sky:BGSprite = new BGSprite('phase0/nevadasky', -1350, -850, 0.9, 0.9);
				sky.updateHitbox();
				add(sky);

				var ground:BGSprite = new BGSprite('phase0/old/nevadagroundold', -2100, -1010, 0.9, 0.9);
				ground.setGraphicSize(Std.int(ground.width * 1.4));
				ground.updateHitbox();
				add(ground);

			case 'nevada2': // phase 0.5
				var ground:BGSprite = new BGSprite('phase0/nevada2ground', -2000, -1000, 0.9, 0.9);
				ground.setGraphicSize(Std.int(ground.width * 1.4));
				ground.updateHitbox();
				add(ground);

			case 'nevadamasks': // masks
				var bg:BGSprite = new BGSprite('phase0/nevadamasksbg', -2100, -1010, 0.9, 0.9);
