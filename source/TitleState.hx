	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
				...
				gfDance.animation.addByPrefix('dance', 'gfDance', 24);
		}
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('coolswag'));
		add(ngSpr);
		ngSpr.visible = false;
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 5:
					...
					#else
					createCoolText(['the mod got an overhaul'], -40);
					#end
				case 7:
					addMoreText('coolswag', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
