...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
				gfDance.frames = Paths.getSparrowAtlas('characters/TrickyPhase0');
				gfDance.animation.addByPrefix('dance', 'Sing Right', 24, true, true);
		...
		ngSpr = new FlxSprite(0, 300).loadGraphic(Paths.image('coolswag'));
		add(ngSpr);
		ngSpr.visible = false;
		ngSpr.updateHitbox();
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 6:
					...
					#else
					createCoolText(['coolswag'], -40);
					#end
				case 8:
					addMoreText('swagcool', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 9:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Phase 0'); // credTextShit.text += '\nFunkin';
