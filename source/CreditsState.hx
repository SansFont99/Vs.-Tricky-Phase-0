...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		['Serkoid',		'serkoid',		'Composer 4 - Masks',	'https://www.youtube.com/channel/UCWXYCOhrmye32o-zvu-GtPQ',	0xFF3E30A8],
		['Burmy Burmington',	'burmy burmington',	'Composer 5 - Tricky has sex with Jebus',	'https://www.youtube.com/channel/UCuRSrMlty6BxDbQDZsboCNw',	0xFFEAABA2],
		['Case',		'case',		'Composer 6 - Calliope 2',	'https://www.youtube.com/channel/UCH7xPJPFID_kPsxaw50vveg',	0xFFB692F6],
		['RoyalRobbie',	'royalrobbie',	'Composer 7 - Engaged',	'https://soundsofroyalty.bandcamp.com/music',	0xFFEBCDFF],
		[''],
		['Psych Engine Team'],
